...
public class Device extends CordovaPlugin {
    ...
    public String getAppVersionName() {
    	String versionName = null;
    	try {
			PackageInfo pInfo = this.cordova.getActivity().getApplicationContext().getPackageManager().getPackageInfo(this.cordova.getActivity().getApplicationContext().getPackageName(), 0);
			versionName = pInfo.versionName;
		} catch (NameNotFoundException e) {
			e.printStackTrace();
		}
